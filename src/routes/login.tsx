      ...
      <div className="card w-full max-w-md p-8">
        ...
        {step === 'otp' && (
          <>
            ...
            />
            <button onClick={verify} disabled={loading || code.length !== 6} className="btn btn-primary w-full mt-4">
              {loading ? 'Verifying…' : 'Sign in'}
            </button>
            <button onClick={() => setStep('phone')} className="btn btn-ghost w-full mt-2">Change number</button>
          </>
        )}
