      ...
      <div className="p-8 grid grid-cols-12 gap-6">
        ...
        <div className="col-span-8 card p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/advisories" className="text-xs text-dal font-medium tracking-wide">
              ALL →
            </Link>
          </div>
          {critical.length === 0 ? (
        ...
        <div className="col-span-4 card p-6">
          ...
          <div className="flex flex-col gap-2">
            <Link href="/destinations" className="btn btn-primary">+ New destination</Link>
            <Link href="/advisories" className="btn btn-secondary">Publish advisory</Link>
            <Link href="/providers" className="btn btn-secondary">Verify provider</Link>
          </div>
        </div>
        ...
        <div className="col-span-12 card p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/destinations" className="text-xs text-dal font-medium tracking-wide">VIEW ALL →</Link>
          </div>
